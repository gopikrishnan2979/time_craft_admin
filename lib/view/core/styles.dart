...
late double khieght;
late double kwidth;
final TextStyle interbold =
    GoogleFonts.inter(fontWeight: FontWeight.bold, color: black);
final TextStyle inter = GoogleFonts.inter(color: black);
final TextStyle interwhite = GoogleFonts.inter(color: white);
final TextStyle interwhitebold =
    GoogleFonts.inter(color: white, fontWeight: FontWeight.bold);
final TextStyle interbluebold = GoogleFonts.inter(
    color: const Color(0xFF3964FC), fontWeight: FontWeight.bold);
String imgpath =
